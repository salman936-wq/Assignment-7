          ...
          <div className="md:col-span-2 flex flex-col gap-4">
            ...
            <div className="bg-white rounded-xl p-5">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <button className="border border-gray-200 cursor-pointer rounded-xl p-4 flex flex-col items-center gap-2 hover:bg-gray-50 transition-colors">
                ...
                <button className="border border-gray-200 rounded-xl p-4 flex flex-col items-center gap-2 cursor-pointer hover:bg-gray-50 transition-colors">
